...
const SideBar = ({ isCollapsed, toggleSidebar }) => {
  ...
  return (
    <header className="no-scrollbar overflow-y-auto text-white fixed top-0 left-0 h-full py-4 px-4 border-l-4 border-gray-500 shadow-lg shadow-gray-700 transition-width duration-300 z-50 hidden md:block">
